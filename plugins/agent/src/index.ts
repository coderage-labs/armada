...
const NATIVE_TOOLS = new Set(['armada_task', 'armada_contacts', 'armada_share', 'armada_steer', 'armada_status', 'armada_workflow_context', 'armada_request_rework']);
...
export default function register(api: any) {
  ...
  api.registerTool({
    ...
    description: 'List available agents — the agents you can communicate with.',
  ...
  api.registerTool({
    name: 'armada_share',
    description: 'Share a file from your workspace so other agents can access it. Returns a reference marker to include in task messages. The receiving agent\'s armada plugin will auto-download the file to their workspace.',
    parameters: {
      type: 'object',
      properties: {
  ...
  // ── Tool: armada_workflow_context ───────────────────────────────

  api.registerTool({
    name: 'armada_workflow_context',
  ...
  // ── Tool: armada_request_rework ─────────────────────────────────

  api.registerTool({
    name: 'armada_request_rework',
