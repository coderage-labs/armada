...
from Agent A doesn't cover a use case. C uses `armada_request_rework` to 
...
1. `armada_workflow_context` tool in armada-agent plugin
...
1. `armada_request_rework` tool in armada-agent plugin
...
1. `armada_escalate` tool in armada-agent plugin
