...
export default function App() {
  const [authed, setAuthed] = useState(() =>
    !!localStorage.getItem('fleet_token') || !!localStorage.getItem('fleet_authed')
  );
  ...
  const handleLogout = () => {
    ...
    localStorage.removeItem('fleet_authed');
    // Clear session cookie by calling logout or just expire it client-side
    document.cookie = 'fleet_session=; Path=/; Expires=Thu, 01 Jan 1970 00:00:00 GMT';
    setAuthed(false);
  };
