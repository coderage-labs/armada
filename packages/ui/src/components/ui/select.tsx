...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex w-full items-center justify-between rounded-lg bg-zinc-800/50 border border-zinc-700",
      "px-3 py-2 text-sm text-zinc-200 transition-colors",
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "border border-zinc-700 bg-zinc-900 text-zinc-200 shadow-lg",
