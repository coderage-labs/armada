    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-zinc-500 mt-0.5">
            Send fleet events to external URLs when things happen.
          </p>
        </div>
        {canMutate && (
          <Button
      ...
      {(loading || webhooks.length > 0) ? (
        ...
        <EmptyState
          ...
          description="Add a webhook to receive notifications when fleet events occur"
    ...
    <div className="space-y-4">
      ...
      {(loading || hooks.length > 0) ? (
        ...
        <EmptyState
          ...
          description="Create one to let external services trigger fleet actions"
...
export default function WebhooksPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader icon={Bell} title="Webhooks" subtitle="Configure webhooks to send and receive fleet events" />
