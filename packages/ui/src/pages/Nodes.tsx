...
export default function Nodes() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader icon={Monitor} title="Nodes" subtitle="Compute nodes in your fleet">
        {canMutate && (
          <Button
            onClick={handleAdd}
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-zinc-500 ml-1">
              — found via mDNS, not yet added to fleet
            </span>
          </div>
          <CardGrid>
      ...
      >
        <div className="space-y-3 text-sm">
          <p className="text-zinc-300">
            Remove <span className="font-medium text-zinc-100">"{confirmRemove?.hostname}"</span> from the fleet?
          </p>
