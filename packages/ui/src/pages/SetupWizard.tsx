...
export default function SetupWizard({ onComplete }: Props) {
  ...
  async function handleCreateAccount(e: FormEvent) {
    ...
    try {
      ...
      localStorage.setItem('fleet_authed', 'passkey');
      setStep('passkey');
    } catch (err: any) {
          ...
          <>
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: '#94a3b8', fontSize: '14px', margin: 0, lineHeight: '1.5' }}>
                Let's set up your fleet control plane. You'll create an owner account
          ...
          <>
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: '#94a3b8', fontSize: '13px', margin: 0 }}>
                This will be the primary admin account for your fleet.
              </p>
            </div>
          ...
          <>
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: '#94a3b8', fontSize: '13px', margin: 0, lineHeight: '1.5' }}>
                {createdUser
                  ? `Welcome, ${createdUser.displayName}. Your fleet control plane is ready.`
                  : 'Your fleet control plane is ready.'}
              </p>
            </div>
