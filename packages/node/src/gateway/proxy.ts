 ...
 *
 * Instances call `http://fleet-gateway:<GATEWAY_PORT>/api/...` or
 * `http://fleet-gateway:<GATEWAY_PORT>/hooks` and this proxy tunnels the request
...
export function startGatewayProxy(): http.Server {
  const server = http.createServer(async (req, res) => {
    ...
    const sourceInstance =
      (req.headers['x-fleet-instance'] as string | undefined) ??
