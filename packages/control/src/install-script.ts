/**
 * Generates a shell script for installing the armada node agent.
 *
 * Usage:
...
ARMADA_NODE_IMAGE="${image}"
CONTAINER_NAME="armada-node-agent"
DATA_DIR="\${ARMADA_DATA_DIR:-\$HOME/armada-data}"
