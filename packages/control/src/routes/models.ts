...
registerToolDef({
  name: 'fleet_models_list',
  description: 'List all models in the fleet model registry.',
  method: 'GET', path: '/api/models',
  parameters: [],
});

registerToolDef({
  name: 'fleet_model_get',
