/**
 * Git credential endpoints for fleet agents.
 *
...
export function createCredentialRoutes(nodeManager: NodeManager): Router {
  ...
  registerToolDef({
    name: 'fleet_agent_credentials_sync',
    description: 'Trigger git credential sync for a fleet agent. Pushes VCS tokens from integrations to the agent container.',
    method: 'POST',
