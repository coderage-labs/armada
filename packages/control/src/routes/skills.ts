...
registerToolDef({
  name: 'fleet_skills',
  description: 'List all available skills across fleet nodes.',
...
registerToolDef({
  name: 'fleet_agent_skill_install',
