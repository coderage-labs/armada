...
registerToolDef({
  name: 'fleet_plugins',
  description: 'List all plugins available in the fleet shared plugins directory.',
  method: 'GET', path: '/api/plugins',
  parameters: [],
});

registerToolDef({
  name: 'fleet_plugin_update',
  description: 'Update a specific plugin in the fleet shared plugins directory.',
...
registerToolDef({
  name: 'fleet_plugins_update_all',
  description: 'Update all plugins in the fleet shared plugins directory.',
  method: 'POST', path: '/api/plugins/update-all',
  parameters: [],
});

const PLUGINS_PATH = process.env.FLEET_PLUGINS_PATH || '/data/fleet/plugins';
