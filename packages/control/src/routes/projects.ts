...
registerToolDef({
  name: 'fleet_projects_list',
  description: 'List all fleet projects. Projects provide shared context for agent workstreams.',
  method: 'GET',
  path: '/api/projects',
  parameters: [
...
registerToolDef({
  name: 'fleet_project_get',
  description: 'Get a single fleet project by ID.',
  method: 'GET',
...
registerToolDef({
  name: 'fleet_project_create',
  description: 'Create a new fleet project.',
  method: 'POST',
  path: '/api/projects',
  parameters: [
...
registerToolDef({
  name: 'fleet_project_update',
  description: 'Update an existing fleet project.',
  method: 'PUT',
  path: '/api/projects/:id',
  parameters: [
    { name: 'id', type: 'string', description: 'Project ID', required: true },
...
registerToolDef({
  name: 'fleet_project_delete',
  description: 'Delete a fleet project.',
  method: 'DELETE',
  path: '/api/projects/:id',
  parameters: [
    { name: 'id', type: 'string', description: 'Project ID', required: true },
...
registerToolDef({
  name: 'fleet_project_archive',
  description: 'Archive a fleet project.',
  method: 'POST',
...
registerToolDef({
  name: 'fleet_project_unarchive',
  description: 'Unarchive a fleet project.',
  method: 'POST',
...
registerToolDef({
  name: 'fleet_project_members',
  description: 'List agent members of a fleet project.',
  method: 'GET',
...
registerToolDef({
  name: 'fleet_project_repos',
  description: 'List repositories linked to a fleet project.',
  method: 'GET',
