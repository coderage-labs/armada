...
registerToolDef({
  name: 'fleet_tools_ensure',
  description: 'Ensure binary tools are installed on a node for fleet agents. Uses eget to download from GitHub releases.',
  method: 'POST',
