...
registerToolDef({
  name: 'fleet_users_list',
  description: 'List all fleet users.',
  method: 'GET',
  path: '/api/users',
  parameters: [],
});
...
registerToolDef({
  name: 'fleet_user_get',
  description: 'Get a fleet user by ID or name.',
  method: 'GET',
  path: '/api/users/:id',
  parameters: [
...
registerToolDef({
  name: 'fleet_user_create',
  description: 'Create a new fleet user.',
  method: 'POST',
  path: '/api/users',
  parameters: [
...
registerToolDef({
  name: 'fleet_user_update',
  description: 'Update a fleet user.',
  method: 'PUT',
  path: '/api/users/:id',
  parameters: [
...
registerToolDef({
  name: 'fleet_user_delete',
  description: 'Delete a fleet user.',
  method: 'DELETE',
  path: '/api/users/:id',
  parameters: [
    { name: 'id', type: 'string', description: 'User ID', required: true },
...
registerToolDef({
  name: 'fleet_user_avatar_generate',
  description: 'Generate an AI avatar for a fleet user.',
  method: 'POST', path: '/api/users/:id/avatar/generate',
  parameters: [{ name: 'id', type: 'string', description: 'User ID', required: true }],
});

registerToolDef({
  name: 'fleet_user_avatar_delete',
  description: 'Delete the avatar for a fleet user.',
