...
registerToolDef({
  name: 'fleet_workflow_run_approve',
...
registerToolDef({
  name: 'fleet_workflow_run_reject',
...
registerToolDef({
  name: 'fleet_workflow_run_cancel',
...
registerToolDef({
  name: 'fleet_workflow_run_context',
...
registerToolDef({
  name: 'fleet_workflow_run_rework',
...
registerToolDef({
  name: 'fleet_workflow_runs_active',
...
registerToolDef({
  name: 'fleet_workflow_runs_recent',
