...
router.post('/:id/steer', requireScope('tasks:write'), async (req, res) => {
  ...
  try {
    const result = await node.relayRequest(containerName, 'POST', '/fleet/steer', body);
    logActivity({
...
router.post('/send', requireScope('tasks:write'), async (req, res) => {
  ...
  const callerName = req.caller?.name || process.env.FLEET_OPERATOR_NAME || 'system';
...
registerToolDef({
  name: 'fleet_tasks_list',
  description: 'List recent fleet tasks with optional filtering by agent or status',
  method: 'GET',
  path: '/api/tasks',
  parameters: [
...
registerToolDef({
  name: 'fleet_task_detail',
  description: 'Get details of a specific fleet task',
  method: 'GET',
  path: '/api/tasks/:id',
  parameters: [
...
registerToolDef({
  ...
  description: 'Record a new fleet task',
  method: 'POST',
  path: '/api/tasks',
  parameters: [
...
registerToolDef({
  name: 'fleet_task_update',
  description: 'Update a fleet task status',
  method: 'PUT',
  path: '/api/tasks/:id',
  parameters: [
    { name: 'id', type: 'string', description: 'Task ID', required: true },
...
registerToolDef({
  name: 'fleet_task_comments_list',
  description: 'List comments/annotations on a fleet task',
  method: 'GET',
...
registerToolDef({
  name: 'fleet_task_comment_add',
  description: 'Add a comment/annotation to a fleet task',
  method: 'POST',
  path: '/api/tasks/:id/comments',
  parameters: [
    { name: 'id', type: 'string', description: 'Task ID', required: true },
...
registerToolDef({
  name: 'fleet_task_comment_delete',
  description: 'Delete a comment from a fleet task',
  method: 'DELETE',
