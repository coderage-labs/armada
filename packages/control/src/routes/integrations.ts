...
registerToolDef({
  name: 'fleet_integration_projects',
...
registerToolDef({
  name: 'fleet_project_integrations_list',
...
registerToolDef({
  name: 'fleet_project_integration_attach',
...
registerToolDef({
  name: 'fleet_project_integration_update',
...
registerToolDef({
  name: 'fleet_project_integration_detach',
...
registerToolDef({
  name: 'fleet_project_integration_sync',
