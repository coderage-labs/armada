...
registerToolDef({
  name: 'fleet_notification_channels_list',
...
registerToolDef({
  name: 'fleet_notification_channels_create',
...
registerToolDef({
  name: 'fleet_notification_channels_update',
...
registerToolDef({
  name: 'fleet_notification_channels_delete',
...
registerToolDef({
  name: 'fleet_notification_channels_test',
