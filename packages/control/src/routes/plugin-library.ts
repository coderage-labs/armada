...
registerToolDef({
  name: 'fleet_plugin_library_list',
  description: 'List all plugins in the fleet plugin library.',
  method: 'GET', path: '/api/plugins/library',
  parameters: [],
});

registerToolDef({
  name: 'fleet_plugin_library_get',
...
registerToolDef({
  name: 'fleet_plugin_library_add',
  description: 'Add a plugin to the fleet plugin library.',
...
registerToolDef({
  name: 'fleet_plugin_library_update',
  description: 'Update a plugin in the fleet plugin library.',
...
registerToolDef({
  name: 'fleet_plugin_library_delete',
  description: 'Remove a plugin from the fleet plugin library.',
...
registerToolDef({
  name: 'fleet_plugin_library_usage',
...
registerToolDef({
  name: 'fleet_plugin_library_pull',
...
registerToolDef({
  name: 'fleet_plugin_library_rollout',
