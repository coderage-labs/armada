...
registerToolDef({
  name: 'fleet_skill_library_list',
  description: 'List all skills in the fleet skill library.',
  method: 'GET', path: '/api/skills/library',
  parameters: [],
});

registerToolDef({
  name: 'fleet_skill_library_get',
...
registerToolDef({
  name: 'fleet_skill_library_add',
  description: 'Add a skill to the fleet skill library.',
...
registerToolDef({
  name: 'fleet_skill_library_update',
  description: 'Update a skill in the fleet skill library.',
...
registerToolDef({
  name: 'fleet_skill_library_delete',
  description: 'Remove a skill from the fleet skill library.',
...
registerToolDef({
  name: 'fleet_skill_library_usage',
...
// This endpoint updates the registry metadata (version, url, etc.) so the fleet knows
