...
registerToolDef({
  ...
  description: 'List all fleet templates. Shows template ID, name, role, and model.',
  method: 'GET', path: '/api/templates',
  parameters: [],
});

registerToolDef({
  name: 'fleet_template_get',
  description: 'Get a single fleet template by ID. Returns full template details including soul, agents, plugins, etc.',
...
registerToolDef({
  name: 'fleet_template_create',
  description: 'Create a new fleet template. Defines the blueprint for spawning agents.',
...
registerToolDef({
  name: 'fleet_template_update',
  description: 'Update an existing fleet template. Only provided fields are changed.',
...
registerToolDef({
  name: 'fleet_template_delete',
  description: 'Delete a fleet template by ID.',
