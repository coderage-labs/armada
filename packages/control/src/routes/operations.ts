...
registerToolDef({
  name: 'fleet_operations_list',
  description: 'List fleet operations with optional status filter',
  method: 'GET',
  path: '/api/operations',
  parameters: [
...
registerToolDef({
  name: 'fleet_operation_get',
  description: 'Get details of a specific fleet operation',
  method: 'GET',
