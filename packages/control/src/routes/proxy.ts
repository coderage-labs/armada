...
function isAgentMember(agentName: string | null, projectName: string): boolean {
  ...
  if (!agent) return true; // Not a fleet agent (e.g., operator instance) — allow through
