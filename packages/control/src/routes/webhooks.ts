...
registerToolDef({
  name: 'fleet_webhooks_create',
  description: 'Create a new webhook that receives POST notifications for fleet events.',
  method: 'POST',
  path: '/api/webhooks',
  parameters: [
