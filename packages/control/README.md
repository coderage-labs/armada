...
|---|---|
| `FLEET_API_TOKEN` | Master API token (required) |
| `FLEET_DB_PATH` | SQLite database path (default: `/data/fleet.db`) |
| `FLEET_API_URL` | Internal URL for agent callbacks (default: `http://armada-control:3001`) |
